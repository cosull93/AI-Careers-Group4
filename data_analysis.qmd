...
### Several variables have NA coorelations of 1. The exceptions are max edu levels, original pay period, title, and msa name. The rest are always NA when one of the other values in the same group are.
